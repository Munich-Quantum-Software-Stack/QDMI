...
| :---------- | :------ | :----------------------------- | :--------------------------------------- |
| [MQSS QDMI] | 1.2.1   | Apache-2.0 with LLVM-exception | QDMI specification and interface headers |
...
| Dependency            | Version | License     | Purpose                      |
| :-------------------- | :------ | :---------- | :--------------------------- |
| [Doxygen]             | 1.15.0  | GNU GPL v2  | API documentation generation |
...
[MQSS QDMI]: https://github.com/Munich-Quantum-Software-Stack/qdmi
