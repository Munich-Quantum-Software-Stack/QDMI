...
#include "v1/constants.h" // IWYU pragma: export
#include "v1/types.h"     // IWYU pragma: export
 ...
 */
int V1_QDMI_device_initialize(void);
 ...
 */
int V1_QDMI_device_finalize(void);
 ...
 *  - Allocate a session with @ref V1_QDMI_device_session_alloc.
 *  - Set parameters for the session with @ref
 * V1_QDMI_device_session_set_parameter.
 *  - Initialize the session with @ref V1_QDMI_device_session_init.
 ...
 *  - Free the session with @ref V1_QDMI_device_session_free when it is no
 * longer needed.
 *
 *  @{
 */
 ...
 */
typedef struct V1_QDMI_Device_Session_impl_d *V1_QDMI_Device_Session;
 ...
 * V1_QDMI_device_session_free when it is no longer used.
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see V1_QDMI_device_session_set_parameter
 * @see V1_QDMI_device_session_init
 */
 ...
 * @ref V1_QDMI_device_session_set_parameter before calling this function. A
 ...
 * @return @ref QDMI_ERROR_FATAL if an unexpected error occurred.
 * @see V1_QDMI_device_session_set_parameter
 * @see V1_QDMI_device_session_query_device_property
 * @see V1_QDMI_device_session_query_site_property
 * @see V1_QDMI_device_session_query_operation_property
 * @see V1_QDMI_device_session_create_device_job
 */
 ...
 *  V1_QDMI_Device_Session handles created via the @ref device_session_interface
 ...
 * @ref V1_QDMI_device_session_init.
 */
int V1_QDMI_device_session_query_device_property(V1_QDMI_Device_Session session,
...
int V1_QDMI_device_session_query_operation_property(
    ...
    size_t num_sites, const V1_QDMI_Site *sites, size_t num_params,
 ...
 *  - Create a job with @ref V1_QDMI_device_session_create_device_job.
 *  - Set parameters for the job with @ref V1_QDMI_device_job_set_parameter.
 *  - Submit the job with @ref V1_QDMI_device_job_submit.
 *  - Check the status of the job with @ref V1_QDMI_device_job_check.
 *  - Wait for the job to finish with @ref V1_QDMI_device_job_wait.
 *  - Retrieve the results of the job with @ref V1_QDMI_device_job_get_results.
 *  - Free the job with @ref V1_QDMI_device_job_free when it is no longer used.
 *
 *  @{
 */
 ...
 */
typedef struct V1_QDMI_Device_Job_impl_d *V1_QDMI_Device_Job;
 ...
 * V1_QDMI_device_job_free when it is no longer used.
 ...
 * functions @ref V1_QDMI_device_job_check and @ref V1_QDMI_device_job_wait can
 * be used to check the status and wait for the job to finish.
 ...
 * V1_QDMI_device_job_get_results.
 ...
 */
int V1_QDMI_device_job_wait(V1_QDMI_Device_Job job, size_t timeout);
