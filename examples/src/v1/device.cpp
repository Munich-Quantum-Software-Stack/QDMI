...
/**
 * @brief Implementation of the V1_QDMI_Device_Session structure.
 * @details This structure can, e.g., be used to store a token to access an API.
 */
enum class V1_QDMI_DEVICE_SESSION_STATUS : uint8_t { ALLOCATED, INITIALIZED };
struct V1_QDMI_Device_Session_impl_d {
  std::string token;
  V1_QDMI_DEVICE_SESSION_STATUS status =
      V1_QDMI_DEVICE_SESSION_STATUS::ALLOCATED;
};

/**
 * @brief Implementation of the V1_QDMI_Device_Job structure.
 * @details This structure can, e.g., be used to store the job id.
 */
struct V1_QDMI_Device_Job_impl_d {
  V1_QDMI_Device_Session session = nullptr;
  int id = 0;
...
/**
 * @brief Implementation of the V1_QDMI_Site structure.
 * @details This structure can, e.g., be used to store the site id.
 */
struct V1_QDMI_Site_impl_d {
  size_t id;
};

/**
 * @brief Implementation of the V1_QDMI_Operation structure.
 * @details This structure can, e.g., be used to store the operation id.
 */
struct V1_QDMI_Operation_impl_d {
  std::string name;
};
 ...
 */
V1_QDMI_Device_State *V1_QDMI_get_device_state() {
  static V1_QDMI_Device_State device_state;
  return &device_state;
}
 ...
 * this file. Hence, it is not part of any header file.
 */
QDMI_Device_Status V1_QDMI_get_device_status() {
  return V1_QDMI_get_device_state()->status;
}
 ...
 * this file. Hence, it is not part of any header file.
 */
void V1_QDMI_set_device_status(QDMI_Device_Status status) {
  V1_QDMI_get_device_state()->status = status;
}
 ...
 * this file. Hence, it is not part of any header file.
 */
int V1_QDMI_generate_job_id() {
  auto *state = V1_QDMI_get_device_state();
 ...
 * this file. Hence, it is not part of any header file.
 */
double V1_QDMI_generate_real() {
  auto *state = V1_QDMI_get_device_state();
  return state->dis_real(state->gen);
}

const V1_QDMI_Operation_impl_d RX{"rx"};
const V1_QDMI_Operation_impl_d RY{"ry"};
const V1_QDMI_Operation_impl_d RZ{"rz"};
const V1_QDMI_Operation_impl_d CX{"cx"};

constexpr std::array<const V1_QDMI_Operation_impl_d *, 4> V1_DEVICE_OPERATIONS =
    {&RX, &RY, &RZ, &CX};

constexpr V1_QDMI_Site_impl_d SITE0{0};
constexpr V1_QDMI_Site_impl_d SITE1{1};
constexpr V1_QDMI_Site_impl_d SITE2{2};
constexpr V1_QDMI_Site_impl_d SITE3{3};
constexpr V1_QDMI_Site_impl_d SITE4{4};

constexpr std::array<const V1_QDMI_Site_impl_d *, 5> V1_DEVICE_SITES = {
    &SITE0, &SITE1, &SITE2, &SITE3, &SITE4};

constexpr std::array<const V1_QDMI_Site_impl_d *, 20>
    // clang-format off
    DEVICE_COUPLING_MAP = {
      V1_DEVICE_SITES[0], V1_DEVICE_SITES[1],
      V1_DEVICE_SITES[1], V1_DEVICE_SITES[0],
      V1_DEVICE_SITES[1], V1_DEVICE_SITES[2],
      V1_DEVICE_SITES[2], V1_DEVICE_SITES[1],
      V1_DEVICE_SITES[2], V1_DEVICE_SITES[3],
      V1_DEVICE_SITES[3], V1_DEVICE_SITES[2],
      V1_DEVICE_SITES[3], V1_DEVICE_SITES[4],
      V1_DEVICE_SITES[4], V1_DEVICE_SITES[3],
      V1_DEVICE_SITES[4], V1_DEVICE_SITES[0],
      V1_DEVICE_SITES[0], V1_DEVICE_SITES[4]};
// clang-format on

const std::unordered_map<const V1_QDMI_Operation_impl_d *,
                         std::pair<std::string, uint64_t>>
    OPERATION_PROPERTIES = {
        {V1_DEVICE_OPERATIONS[0], {"rx", 10}},
        {V1_DEVICE_OPERATIONS[1], {"ry", 10}},
        {V1_DEVICE_OPERATIONS[2], {"rz", 10}},
        {V1_DEVICE_OPERATIONS[3], {"cx", 100}},
};

struct V1_QDMI_Pair_hash {
...
const std::unordered_map<
    const V1_QDMI_Operation_impl_d *,
    std::unordered_map<
        std::pair<const V1_QDMI_Site_impl_d *, const V1_QDMI_Site_impl_d *>,
        double, V1_QDMI_Pair_hash>>
    OPERATION_FIDELITIES = {
        {V1_DEVICE_OPERATIONS[3],
         {{{V1_DEVICE_SITES[0], V1_DEVICE_SITES[1]}, 0.99},
          {{V1_DEVICE_SITES[1], V1_DEVICE_SITES[0]}, 0.99},
          {{V1_DEVICE_SITES[1], V1_DEVICE_SITES[2]}, 0.98},
          {{V1_DEVICE_SITES[2], V1_DEVICE_SITES[1]}, 0.98},
          {{V1_DEVICE_SITES[2], V1_DEVICE_SITES[3]}, 0.97},
          {{V1_DEVICE_SITES[3], V1_DEVICE_SITES[2]}, 0.97},
          {{V1_DEVICE_SITES[3], V1_DEVICE_SITES[4]}, 0.96},
          {{V1_DEVICE_SITES[4], V1_DEVICE_SITES[3]}, 0.96},
          {{V1_DEVICE_SITES[4], V1_DEVICE_SITES[0]}, 0.95},
          {{V1_DEVICE_SITES[0], V1_DEVICE_SITES[4]}, 0.95}}},
...
int V1_QDMI_device_initialize() {
  V1_QDMI_set_device_status(QDMI_DEVICE_STATUS_IDLE);
  return QDMI_SUCCESS;
} /// [DOXYGEN FUNCTION END]

int V1_QDMI_device_finalize() {
  V1_QDMI_set_device_status(QDMI_DEVICE_STATUS_OFFLINE);
  return QDMI_SUCCESS;
} /// [DOXYGEN FUNCTION END]

int V1_QDMI_device_session_alloc(V1_QDMI_Device_Session *session) {
  if (session == nullptr) {
    return QDMI_ERROR_INVALIDARGUMENT;
  }
  *session = new V1_QDMI_Device_Session_impl_d();
  return QDMI_SUCCESS;
} /// [DOXYGEN FUNCTION END]

int V1_QDMI_device_session_init(V1_QDMI_Device_Session session) {
  if (session == nullptr) {
    return QDMI_ERROR_INVALIDARGUMENT;
  }
  switch (V1_QDMI_get_device_status()) {
  ...
  session->status = V1_QDMI_DEVICE_SESSION_STATUS::INITIALIZED;
  return QDMI_SUCCESS;
} /// [DOXYGEN FUNCTION END]

void V1_QDMI_device_session_free(V1_QDMI_Device_Session session) {
  delete session;
} /// [DOXYGEN FUNCTION END]

int V1_QDMI_device_session_set_parameter(V1_QDMI_Device_Session session,
  ...
  if (session->status != V1_QDMI_DEVICE_SESSION_STATUS::ALLOCATED) {
...
int V1_QDMI_device_session_create_device_job(V1_QDMI_Device_Session session,
                                             V1_QDMI_Device_Job *job) {
  if (session == nullptr || job == nullptr) {
    return QDMI_ERROR_INVALIDARGUMENT;
  }
  if (session->status != V1_QDMI_DEVICE_SESSION_STATUS::INITIALIZED) {
    return QDMI_ERROR_BADSTATE;
  }

  *job = new V1_QDMI_Device_Job_impl_d;
  (*job)->session = session;
  // set job id to random number for demonstration purposes
  (*job)->id = V1_QDMI_generate_job_id();
  (*job)->status = QDMI_JOB_STATUS_CREATED;
  return QDMI_SUCCESS;
} /// [DOXYGEN FUNCTION END]

void V1_QDMI_device_job_free(V1_QDMI_Device_Job job) {
  delete[] static_cast<char *>(job->program);
  delete job;
} /// [DOXYGEN FUNCTION END]

int V1_QDMI_device_job_set_parameter(V1_QDMI_Device_Job job,
...
int V1_QDMI_device_job_query_property(V1_QDMI_Device_Job job,
...
int V1_QDMI_device_job_submit(V1_QDMI_Device_Job job) {
  ...
  V1_QDMI_set_device_status(QDMI_DEVICE_STATUS_BUSY);
  ...
  size_t num_qubits = 0;
  V1_QDMI_device_session_query_device_property(
  ...
  for (size_t i = 0; i < job->num_shots; ++i) {
    ...
    std::ranges::generate(result,
                          [&]() { return V1_QDMI_generate_bit() ? '1' : '0'; });
  ...
  for (size_t i = 0; i < 1U << num_qubits; ++i) {
    const auto &c = job->state_vec.emplace_back(V1_QDMI_generate_real(),
                                                V1_QDMI_generate_real());
    norm += std::norm(c);
  }
...
int V1_QDMI_device_job_cancel(V1_QDMI_Device_Job job) {
...
int V1_QDMI_device_job_check(V1_QDMI_Device_Job job, QDMI_Job_Status *status) {
  if (job == nullptr || status == nullptr) {
    return QDMI_ERROR_INVALIDARGUMENT;
  }
  // randomly decide whether job is done or not
  if (job->status == QDMI_JOB_STATUS_RUNNING && V1_QDMI_generate_bit()) {
    V1_QDMI_set_device_status(QDMI_DEVICE_STATUS_IDLE);
    job->status = QDMI_JOB_STATUS_DONE;
  }
  *status = job->status;
...
int V1_QDMI_device_job_wait(V1_QDMI_Device_Job job,
...
namespace {
int V1_QDMI_device_job_get_results_shots(V1_QDMI_Device_Job job,
                                         const size_t size, void *data,
                                         size_t *size_ret) {
  const size_t req_size =
      job->results.size() * (job->results.front().length() + 1);
  if (data != nullptr) {
    if (size < req_size) {
      return QDMI_ERROR_INVALIDARGUMENT;
    }
...
int V1_QDMI_device_job_get_results_hist(V1_QDMI_Device_Job job,
...
int V1_QDMI_device_job_get_results_statevector(V1_QDMI_Device_Job job,
                                               const size_t size, void *data,
                                               size_t *size_ret) {
...
int V1_QDMI_device_job_get_results_sparse(V1_QDMI_Device_Job job,
                                          const QDMI_Job_Result result,
                                          const size_t size, void *data,
                                          size_t *size_ret) {
  ...
  const auto num_qubits = static_cast<size_t>(std::log2(job->state_vec.size()));
...
int V1_QDMI_device_job_get_results_probabilities(V1_QDMI_Device_Job job,
                                                 const size_t size, void *data,
                                                 size_t *size_ret) {
...
int V1_QDMI_device_job_get_results(V1_QDMI_Device_Job job,
                                   const QDMI_Job_Result result,
                                   const size_t size, void *data,
                                   size_t *size_ret) {
  if (job == nullptr || job->status != QDMI_JOB_STATUS_DONE ||
  ...
  case QDMI_JOB_RESULT_SHOTS:
    return V1_QDMI_device_job_get_results_shots(job, size, data, size_ret);
  case QDMI_JOB_RESULT_HIST_KEYS:
  case QDMI_JOB_RESULT_HIST_VALUES:
    return V1_QDMI_device_job_get_results_hist(job, result, size, data,
                                               size_ret);
  case QDMI_JOB_RESULT_STATEVECTOR_DENSE:
    return V1_QDMI_device_job_get_results_statevector(job, size, data,
                                                      size_ret);
  case QDMI_JOB_RESULT_STATEVECTOR_SPARSE_KEYS:
  case QDMI_JOB_RESULT_STATEVECTOR_SPARSE_VALUES:
  case QDMI_JOB_RESULT_PROBABILITIES_SPARSE_KEYS:
  case QDMI_JOB_RESULT_PROBABILITIES_SPARSE_VALUES:
    return V1_QDMI_device_job_get_results_sparse(job, result, size, data,
                                                 size_ret);
  case QDMI_JOB_RESULT_PROBABILITIES_DENSE:
    return V1_QDMI_device_job_get_results_probabilities(job, size, data,
                                                        size_ret);
  default:
    return QDMI_ERROR_NOTSUPPORTED;
  }
...
int V1_QDMI_device_session_query_device_property(
    V1_QDMI_Device_Session session, const QDMI_Device_Property prop,
  ...
  ADD_STRING_PROPERTY(QDMI_DEVICE_PROPERTY_VERSION, V1_QDMI_DEVICE_VERSION,
                      prop, size, value, size_ret)
  // NOLINTNEXTLINE(misc-include-cleaner)
  ADD_STRING_PROPERTY(QDMI_DEVICE_PROPERTY_LIBRARYVERSION, QDMI_VERSION, prop,
                      size, value, size_ret)
  ADD_SINGLE_VALUE_PROPERTY(QDMI_DEVICE_PROPERTY_STATUS, QDMI_Device_Status,
                            V1_QDMI_get_device_status(), prop, size, value,
                            size_ret)
  ADD_SINGLE_VALUE_PROPERTY(QDMI_DEVICE_PROPERTY_QUBITSNUM, size_t, 5, prop,
                            size, value, size_ret)
  ADD_LIST_PROPERTY(QDMI_DEVICE_PROPERTY_SITES, V1_QDMI_Site, V1_DEVICE_SITES,
                    prop, size, value, size_ret)
  ADD_LIST_PROPERTY(QDMI_DEVICE_PROPERTY_OPERATIONS, V1_QDMI_Operation,
                    V1_DEVICE_OPERATIONS, prop, size, value, size_ret)
  ADD_LIST_PROPERTY(QDMI_DEVICE_PROPERTY_COUPLINGMAP, V1_QDMI_Site,
...
int V1_QDMI_device_session_query_site_property(V1_QDMI_Device_Session session,
                                               V1_QDMI_Site site,
...
int V1_QDMI_device_session_query_operation_property(
    V1_QDMI_Device_Session session, V1_QDMI_Operation operation,
    const size_t num_sites, const V1_QDMI_Site *sites, const size_t num_params,
  ...
  ADD_SINGLE_VALUE_PROPERTY(QDMI_OPERATION_PROPERTY_ISZONED, bool, false, prop,
                            size, value, size_ret)
  if (operation == V1_DEVICE_OPERATIONS[3]) {
    ...
    ADD_SINGLE_VALUE_PROPERTY(QDMI_OPERATION_PROPERTY_DURATION, uint64_t,
                              ...
                              size, value, size_ret)
    ADD_LIST_PROPERTY(QDMI_OPERATION_PROPERTY_SITES, V1_QDMI_Site,
                      DEVICE_COUPLING_MAP, prop, size, value, size_ret)
    if (sites == nullptr) {
  ...
  } else if (operation == V1_DEVICE_OPERATIONS[0] ||
             operation == V1_DEVICE_OPERATIONS[1] ||
             operation == V1_DEVICE_OPERATIONS[2]) {
    ...
    ADD_SINGLE_VALUE_PROPERTY(QDMI_OPERATION_PROPERTY_FIDELITY, double, 0.999,
                              prop, size, value, size_ret)
    ADD_LIST_PROPERTY(QDMI_OPERATION_PROPERTY_SITES, V1_QDMI_Site,
                      V1_DEVICE_SITES, prop, size, value, size_ret)
  }
  return QDMI_ERROR_NOTSUPPORTED;
} /// [DOXYGEN FUNCTION END]
