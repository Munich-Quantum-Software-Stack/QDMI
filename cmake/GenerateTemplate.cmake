...
# file(REAL_PATH ...) fails if the path doesn't (yet) exist on some platforms/CMakes.
# Use REAL_PATH only when the path exists; otherwise compute an absolute path
# which does not require the target to exist.
if(EXISTS "${QDMI_TEMPLATE_SOURCE_DIR}")
  file(REAL_PATH "${QDMI_TEMPLATE_SOURCE_DIR}" QDMI_TEMPLATE_SOURCE_DIR)
else()
  get_filename_component(QDMI_TEMPLATE_SOURCE_DIR "${QDMI_TEMPLATE_SOURCE_DIR}" ABSOLUTE)
endif()

if(EXISTS "${QDMI_TEMPLATE_OUTPUT_DIR}")
  file(REAL_PATH "${QDMI_TEMPLATE_OUTPUT_DIR}" QDMI_TEMPLATE_OUTPUT_DIR)
else()
  get_filename_component(QDMI_TEMPLATE_OUTPUT_DIR "${QDMI_TEMPLATE_OUTPUT_DIR}" ABSOLUTE)
endif()
