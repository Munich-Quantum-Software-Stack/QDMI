...
enum QDMI_ENVIRONMENT_PROPERTY_T {
  ...
  QDMI_ENVIRONMENT_PROPERTY_MAX = 1,
...
enum QDMI_ENVIRONMENT_QUERY_PARAMETER_T {
  ...
  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX = 2,

  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX_CUSTOM1 = 999999995,

  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX_CUSTOM2 = 999999996,

  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX_CUSTOM3 = 999999997,

  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX_CUSTOM4 = 999999998,

  QDMI_ENVIRONMENT_QUERY_PARAMETER_MAX_CUSTOM5 = 999999999
};
...
enum QDMI_ENVIRONMENT_QUERY_RESULT_T {
  ...
  QDMI_ENVIRONMENT_QUERY_RESULT_START_TIME = 0,

  QDMI_ENVIRONMENT_QUERY_RESULT_END_TIME = 1,

  QDMI_ENVIRONMENT_QUERY_RESULT_VALUE = 2,

  QDMI_ENVIRONMENT_QUERY_RESULT_MAX = 3,
