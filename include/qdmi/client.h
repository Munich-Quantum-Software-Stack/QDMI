 ...
 * QDMI_job_query_job_property as part of the @ref client_interface
 * "client interface".
...
enum QDMI_JOB_PROPERTY_T {
   ...
   * @details This ID must be unique for the device and the session. The ID can,
   * for example, correspond to the job ID provided via @ref
   * QDMI_device_job_query_job_property as part of the @ref
   * device_interface "device interface" or can be generated by the QDMI Driver
   * implementation.
   */
