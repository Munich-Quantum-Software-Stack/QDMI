 ...
 * devices.
 */
int QDMI_session_query_devices(QDMI_Session session, size_t num_entries,
...
/**
 * @brief Query the sites associated with @p device.
 * @param[in] device The device to query. Must not be @c NULL.
 ...
 */
int QDMI_device_query_sites(QDMI_Device device, size_t num_entries,
...
/**
 * @brief Query the operations available on @p device.
 * @param[in] device The device to query. Must not be @c NULL.
 ...
 */
int QDMI_device_query_operations(QDMI_Device device, size_t num_entries,
